...
function MovieForm({ isModalOpen, setIsModalOpen, formType , setFormType, selectedMovie , setSelectedMovie }) {
  ...
  return (
    <Modal open={isModalOpen} width={800} onCancel={handleCancel} onOk={() => form.submit()}>
      <Form  form={form} initialValues={selectedMovie} layout="vertical" style={{ width: "100%" }} onFinish={onFinish}>
        <Row
          gutter={{
            xs: 6,
            sm: 10,
